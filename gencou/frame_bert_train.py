"""
Takes training texts and transforms these to feature vectors, then trains the model with 40 epochs.
...
REPORTS_DIR = f'../data/frames/reports/{TASK_NAME}_evaluation_report/'
